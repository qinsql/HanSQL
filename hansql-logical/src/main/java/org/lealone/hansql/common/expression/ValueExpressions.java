 ...
 */
package org.lealone.hansql.common.expression;
...
public class ValueExpressions {
    ...
    public static LogicalExpression getDate(GregorianCalendar date) {
        return new org.lealone.hansql.common.expression.ValueExpressions.DateExpression(date.getTimeInMillis());
    }

    public static LogicalExpression getDate(long milliSecond) {
        return new org.lealone.hansql.common.expression.ValueExpressions.DateExpression(milliSecond);
    }
    ...
    public static LogicalExpression getTime(GregorianCalendar time) {
        int millis = time.get(GregorianCalendar.HOUR_OF_DAY) * 60 * 60 * 1000
                + time.get(GregorianCalendar.MINUTE) * 60 * 1000 + time.get(GregorianCalendar.SECOND) * 1000
    ...
    public static LogicalExpression getTimeStamp(GregorianCalendar date) {
        return new org.lealone.hansql.common.expression.ValueExpressions.TimeStampExpression(date.getTimeInMillis());
    }

    public static LogicalExpression getTimeStamp(long milliSeconds) {
        return new org.lealone.hansql.common.expression.ValueExpressions.TimeStampExpression(milliSeconds);
    }
    ...
    public static class Decimal9Expression extends LogicalExpressionBase {
        ...
        @Override
        public MajorType getMajorType() {
            return MajorType.newBuilder().setMinorType(MinorType.DECIMAL9).setScale(scale).setPrecision(precision)
    ...
    public static class Decimal18Expression extends LogicalExpressionBase {
        ...
        @Override
        public MajorType getMajorType() {
            return MajorType.newBuilder().setMinorType(MinorType.DECIMAL18).setScale(scale).setPrecision(precision)
                    .setMode(DataMode.REQUIRED).build();
        }
    ...
    public static class Decimal28Expression extends LogicalExpressionBase {
        ...
        @Override
        public MajorType getMajorType() {
            return MajorType.newBuilder().setMinorType(MinorType.DECIMAL28SPARSE).setScale(bigDecimal.scale())
                    .setPrecision(bigDecimal.precision()).setMode(DataMode.REQUIRED).build();
        }
    ...
    public static class Decimal38Expression extends LogicalExpressionBase {
        ...
        @Override
        public MajorType getMajorType() {
            return MajorType.newBuilder().setMinorType(MinorType.DECIMAL38SPARSE).setScale(bigDecimal.scale())
                    .setPrecision(bigDecimal.precision()).setMode(DataMode.REQUIRED).build();
        }
    ...
    public static class VarDecimalExpression extends LogicalExpressionBase {
        ...
        @Override
        public MajorType getMajorType() {
            return MajorType.newBuilder().setMinorType(MinorType.VARDECIMAL).setScale(scale).setPrecision(precision)
                    .setMode(DataMode.REQUIRED).build();
        }
