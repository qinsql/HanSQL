...
import org.lealone.hansql.exec.expr.holders.RepeatedBigIntHolder;
import org.lealone.hansql.exec.expr.holders.RepeatedBitHolder;
import org.lealone.hansql.exec.expr.holders.RepeatedFloat4Holder;
import org.lealone.hansql.exec.expr.holders.RepeatedFloat8Holder;
import org.lealone.hansql.exec.expr.holders.RepeatedIntHolder;
import org.lealone.hansql.exec.expr.holders.RepeatedTinyIntHolder;
import org.lealone.hansql.exec.expr.holders.RepeatedVarCharHolder;
  ...
  public static class ContainsVarChar implements DrillSimpleFunc {
    ...
    public void setup() {
      ...
      matcher = java.util.regex.Pattern.compile(
          org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(targetValue.start,  targetValue.end,  targetValue.buffer)).matcher("");
