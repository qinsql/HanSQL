  ...
  * */
  ...
  public static class HllFieldReader implements DrillAggFunc {
    ...
    public void setup() {
      ...
      hllAccuracy.value = (int) options.getLong(org.lealone.hansql.exec.ExecConstants.HLL_ACCURACY);
    ...
    public void add() {
      if (work.obj != null) {
        ...
        switch (mode) {
          case org.lealone.hansql.common.types.TypeProtos.DataMode.OPTIONAL_VALUE:
            if (!in.isSet()) {
              hll.offer(null);
              break;
            }
            // fall through //
          case org.lealone.hansql.common.types.TypeProtos.DataMode.REQUIRED_VALUE:
            switch (type) {
              case org.lealone.hansql.common.types.TypeProtos.MinorType.VARCHAR_VALUE:
                hll.offer(in.readText().toString());
                break;
              case org.lealone.hansql.common.types.TypeProtos.MinorType.BIGINT_VALUE:
    ...
    public void output() {
      if (work.obj != null) {
        ...
        try {
          ...
          throw new org.lealone.hansql.common.exceptions.DrillRuntimeException("Failed to get HyperLogLog output", e);
        }
      } else {
        out.isSet = 0;
      }
    ...
    public void eval() {
      ...
      if (in.isSet != 0) {
        ...
        try {
          ...
          throw new org.lealone.hansql.common.exceptions.DrillRuntimeException("Failure evaluating hll_decode", e);
        }
      }
    }
  }
  ...
  public static class HllMerge implements DrillAggFunc {
    ...
    public void add() {
      if (work.obj != null) {
        ...
        try {
          if (in.isSet != 0) {
            byte[] buf = org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(
          ...
          throw new org.lealone.hansql.common.exceptions.DrillRuntimeException("Failed to merge HyperLogLog output", e);
        }
      }
    }
  ...
  public static class Var16CharHLLFunction implements DrillAggFunc {
    ...
    public void add() {
      if (work.obj != null) {
        com.clearspring.analytics.stream.cardinality.HyperLogLog hll =
                (com.clearspring.analytics.stream.cardinality.HyperLogLog) work.obj;
        byte[] buf = org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF16
                (in.start, in.end, in.buffer).getBytes();
        hll.offer(buf);
      }
    }
  ...
  public static class VarCharAvgWidthFunction implements DrillAggFunc {
    ...
    @Override
    public void add() {
      totWidth.value += org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(
  ...
  public static class Var16CharAvgWidthFunction implements DrillAggFunc {
    ...
    @Override
    public void add() {
      totWidth.value += org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF16(
              in.start, in.end, in.buffer).getBytes().length;
      count.value++;
    }
  ...
  public static class BitCntDupsFunction implements DrillAggFunc {
    ...
    public void setup() {
      work = new ObjectHolder();
      dups.value = 0;
      ndvBloomFilterElts.value = (int) options.getLong(org.lealone.hansql.exec.ExecConstants.NDV_BLOOM_FILTER_ELEMENTS);
      ndvBloomFilterFPProb.value = (int) options.getLong(org.lealone.hansql.exec.ExecConstants.NDV_BLOOM_FILTER_FPOS_PROB);
