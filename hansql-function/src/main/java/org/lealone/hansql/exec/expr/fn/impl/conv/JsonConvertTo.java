 ...
 static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(JsonConvertTo.class);
  ...
  public static class ConvertToJson implements DrillSimpleFunc{
    ...
    public void eval(){
      ...
      try {
        org.lealone.hansql.exec.vector.complex.fn.JsonWriter jsonWriter = new org.lealone.hansql.exec.vector.complex.fn.JsonWriter(stream, true, false);
  ...
  public static class ConvertToExtendedJson implements DrillSimpleFunc{
    ...
    public void eval(){
      ...
      java.io.ByteArrayOutputStream stream = new java.io.ByteArrayOutputStream();
      try {
        org.lealone.hansql.exec.vector.complex.fn.JsonWriter jsonWriter = new org.lealone.hansql.exec.vector.complex.fn.JsonWriter(stream, true, true);
