...
public class SimpleCastFunctions {
  ...
  public static class CastVarCharBoolean implements DrillSimpleFunc {
    ...
    public void eval() {
      ...
      out.value = org.lealone.hansql.common.types.BooleanType.get(input).getNumericValue();
    }
  }
  ...
  public static class CastBooleanVarChar implements DrillSimpleFunc {
    ...
    public void eval() {
      byte[] outB = org.lealone.hansql.common.types.BooleanType.get(String.valueOf(in.value)).name().toLowerCase().getBytes();
