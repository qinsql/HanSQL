...
import org.lealone.hansql.exec.ops.ContextInformation;
...
public class DateTypeFunctions {
    ...
    public static class IsDate implements DrillSimpleFunc {
      ...
      public void eval() {
        ...
        if (in.isSet == 0) {
          ...
          out.value = org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.isReadableAsDate(in.buffer, in.start, in.end) ? 1 : 0;
        }
      }
    }
    ...
    public static class IntervalType implements DrillSimpleFunc {
        ...
        public void eval() {
            ...
            out.months       =  (int) ((inputYears.value * org.lealone.hansql.exec.vector.DateUtilities.yearsToMonths) +
                                       (inputMonths.value));
            out.days         =  (int) inputDays.value;
            out.milliseconds =  (int) ((inputHours.value * org.lealone.hansql.exec.vector.DateUtilities.hoursToMillis) +
                                       (inputMinutes.value * org.lealone.hansql.exec.vector.DateUtilities.minutesToMillis) +
                                       (inputSeconds.value * org.lealone.hansql.exec.vector.DateUtilities.secondsToMillis) +
    ...
    public static class IntervalYearType implements DrillSimpleFunc {
        ...
        public void eval() {
            ...
            out.value       = (int) ((inputYears.value * org.lealone.hansql.exec.vector.DateUtilities.yearsToMonths) +
                                      (inputMonths.value));
        }
    }
    ...
    public static class TimeType implements DrillSimpleFunc {
        ...
        @Override
        public void eval() {
            out.value = (int) ((inputHours.value * org.lealone.hansql.exec.vector.DateUtilities.hoursToMillis) +
                               (inputMinutes.value * org.lealone.hansql.exec.vector.DateUtilities.minutesToMillis) +
                               (inputSeconds.value * org.lealone.hansql.exec.vector.DateUtilities.secondsToMillis) +
                                inputMilliSeconds.value);
        }
    ...
    public static class CurrentDate implements DrillSimpleFunc {
        ...
        public void setup() {
            ...
            org.joda.time.DateTimeZone timeZone = org.joda.time.DateTimeZone.forID(org.lealone.hansql.exec.expr.fn.impl.DateUtility.getTimeZone(timeZoneIndex));
    ...
    public static class TimeOfDay implements DrillSimpleFunc {
        ...
        public void eval() {
            ...
            String str = org.lealone.hansql.exec.expr.fn.impl.DateUtility.formatTimeStampTZ.format(temp);
            out.buffer = buffer;
            out.start = 0;
    ...
    public static class LocalTimeStampNiladic implements DrillSimpleFunc {
        ...
        @Override
        public void setup() {
            queryStartDate = org.lealone.hansql.exec.expr.fn.impl.DateTypeFunctions.getQueryStartDate(contextInfo);
        }
    ...
    public static class CurrentTime implements DrillSimpleFunc {
        ...
        public void setup() {
            ...
            org.joda.time.DateTimeZone timeZone = org.joda.time.DateTimeZone.forID(org.lealone.hansql.exec.expr.fn.impl.DateUtility.getTimeZone(timeZoneIndex));
            org.joda.time.DateTime now = new org.joda.time.DateTime(contextInfo.getQueryStartTime(), timeZone);
            queryStartTime= (now.getHourOfDay() * org.lealone.hansql.exec.vector.DateUtilities.hoursToMillis) +
                                   (now.getMinuteOfHour() * org.lealone.hansql.exec.vector.DateUtilities.minutesToMillis) +
                                   (now.getSecondOfMinute() * org.lealone.hansql.exec.vector.DateUtilities.secondsToMillis) +
    ...
    public static class AgeTimeStampFunction implements DrillSimpleFunc {
        ...
        public void eval() {
            ...
            long days = diff / org.lealone.hansql.exec.vector.DateUtilities.daysToStandardMillis;
            out.months = (int) (days / org.lealone.hansql.exec.vector.DateUtilities.monthToStandardDays);
            out.days = (int) (days % org.lealone.hansql.exec.vector.DateUtilities.monthToStandardDays);
            out.milliseconds = (int) (diff % org.lealone.hansql.exec.vector.DateUtilities.daysToStandardMillis);
        }
    }
    ...
    public static class CastTimeStampToTime implements DrillSimpleFunc {
        ...
        @Override
        public void eval() {
            out.value = (int) (in.value % org.lealone.hansql.exec.vector.DateUtilities.daysToStandardMillis);
        }
    }
    ...
    public static class UnixTimeStampForDate implements DrillSimpleFunc {
      ...
      @Override
      public void eval() {
        String inputDate = org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(inputDateValue.start, inputDateValue.end, inputDateValue.buffer);
    ...
    public static class UnixTimeStampForDateWithPattern implements DrillSimpleFunc {
      ...
      @Override
      public void setup() {
         String pattern = org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(inputPattern.start, inputPattern.end, inputPattern.buffer);
