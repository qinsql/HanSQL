...
public class ParseUrlFunction {
  ...
  public static class ParseUrl implements DrillSimpleFunc {
    ...
    @Override
    public void eval() {
      org.lealone.hansql.exec.vector.complex.writer.BaseWriter.MapWriter mapWriter = outWriter.rootAsMap();
      ...
      try {
        ...
        org.lealone.hansql.exec.expr.holders.VarCharHolder rowHolder =
            new org.lealone.hansql.exec.expr.holders.VarCharHolder();
        ...
        if (port != -1) {
          org.lealone.hansql.exec.expr.holders.IntHolder intHolder = new org.lealone.hansql.exec.expr.holders.IntHolder();
