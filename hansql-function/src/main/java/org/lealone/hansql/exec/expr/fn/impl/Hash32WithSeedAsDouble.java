...
public class Hash32WithSeedAsDouble {
  ...
  public static class NullableFloatHash implements DrillSimpleFunc {
    ...
    public void eval() {
      if (in.isSet == 0) {
        ...
        out.value = org.lealone.hansql.exec.expr.fn.impl.HashHelper.hash32((double) in.value, seed.value);
      }
    }
  }
  ...
  public static class NullableDoubleHash implements DrillSimpleFunc {
    ...
    public void eval() {
      if (in.isSet == 0) {
        ...
        out.value = org.lealone.hansql.exec.expr.fn.impl.HashHelper.hash32(in.value, seed.value);
      }
    }
  }
  ...
  public static class VarDecimalHash implements DrillSimpleFunc {
    ...
    public void eval() {
      ...
      out.value = org.lealone.hansql.exec.expr.fn.impl.HashHelper.hash32(bd.doubleValue(), seed.value);
    }
  }
