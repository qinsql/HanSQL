...
import org.lealone.hansql.exec.expr.annotations.FunctionTemplate.OutputWidthCalculatorType;
...
public class StringFunctions{
  ...
  public static class Like implements DrillSimpleFunc {
    ...
    @Workspace org.lealone.hansql.exec.expr.fn.impl.RegexpUtil.SqlPatternInfo sqlPatternInfo;
    @Workspace org.lealone.hansql.exec.expr.fn.impl.SqlPatternMatcher sqlPatternMatcher;

    @Override
    public void setup() {
      sqlPatternInfo = org.lealone.hansql.exec.expr.fn.impl.RegexpUtil.sqlToRegexLike(
          org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(pattern.start, pattern.end, pattern.buffer));
      sqlPatternMatcher = org.lealone.hansql.exec.expr.fn.impl.SqlPatternFactory.getSqlPatternMatcher(sqlPatternInfo);
    }
  ...
  public static class LikeWithEscape implements DrillSimpleFunc {
    ...
    public void setup() {
      sqlPatternInfo = org.lealone.hansql.exec.expr.fn.impl.RegexpUtil.sqlToRegexLike(
          org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(pattern.start,  pattern.end,  pattern.buffer),
          org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(escape.start,  escape.end,  escape.buffer));
      sqlPatternMatcher = org.lealone.hansql.exec.expr.fn.impl.SqlPatternFactory.getSqlPatternMatcher(sqlPatternInfo);
    }
  ...
  public static class ILike implements DrillSimpleFunc {
    ...
    @Workspace org.lealone.hansql.exec.expr.fn.impl.CharSequenceWrapper charSequenceWrapper;

    @Override
    public void setup() {
      matcher = java.util.regex.Pattern.compile(org.lealone.hansql.exec.expr.fn.impl.RegexpUtil.sqlToRegexLike( //
          org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(pattern.start,  pattern.end,  pattern.buffer)).getJavaPatternString(),
          java.util.regex.Pattern.CASE_INSENSITIVE).matcher("");
      charSequenceWrapper = new org.lealone.hansql.exec.expr.fn.impl.CharSequenceWrapper();
  ...
  public static class ILikeWithEscape implements DrillSimpleFunc {
    ...
    public void setup() {
      matcher = java.util.regex.Pattern.compile(org.lealone.hansql.exec.expr.fn.impl.RegexpUtil.sqlToRegexLike( //
          org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(pattern.start,  pattern.end,  pattern.buffer),
          org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(escape.start,  escape.end,  escape.buffer)).getJavaPatternString(),
          java.util.regex.Pattern.CASE_INSENSITIVE).matcher("");
      charSequenceWrapper = new org.lealone.hansql.exec.expr.fn.impl.CharSequenceWrapper();
      matcher.reset(charSequenceWrapper);
    }
  ...
  public static class Similar implements DrillSimpleFunc {
    ...
    @Override
    public void setup() {
      matcher = java.util.regex.Pattern.compile(org.lealone.hansql.exec.expr.fn.impl.RegexpUtil.sqlToRegexSimilar(
          org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers
  ...
  public static class SimilarWithEscape implements DrillSimpleFunc {
    ...
    public void setup() {
      matcher = java.util.regex.Pattern.compile(org.lealone.hansql.exec.expr.fn.impl.RegexpUtil.sqlToRegexSimilar(
          org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(pattern.start,  pattern.end,  pattern.buffer),
          org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(escape.start,  escape.end,  escape.buffer))).matcher("");
      charSequenceWrapper = new org.lealone.hansql.exec.expr.fn.impl.CharSequenceWrapper();
      matcher.reset(charSequenceWrapper);
    }
  ...
  public static class RegexpReplace implements DrillSimpleFunc {
    ...
    @Override
    public void setup() {
      matcher = java.util.regex.Pattern.compile(org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(
    ...
    public void eval() {
      out.start = 0;
      charSequenceWrapper.setBuffer(input.start, input.end, input.buffer);
      final String r = org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(replacement.start, replacement.end, replacement.buffer);
      // Reusing same charSequenceWrapper, no need to pass it in.
      matcher.reset();
  ...
  public static class RegexpMatches implements DrillSimpleFunc {
    ...
    @Override
    public void setup() {
      matcher = java.util.regex.Pattern.compile(org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(pattern.start,  pattern.end,  pattern.buffer)).matcher("");
      charSequenceWrapper = new org.lealone.hansql.exec.expr.fn.impl.CharSequenceWrapper();
      matcher.reset(charSequenceWrapper);
    }
  ...
  public static class CharLength implements DrillSimpleFunc {
    ...
    @Override
    public void eval() {
      out.value = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.getUTF8CharLength(input.buffer, input.start, input.end);
    }
  }
  ...
  public static class Position implements DrillSimpleFunc {
    ...
    public void eval() {
      //Do string match.
      final int pos = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.stringLeftMatchUTF8(str.buffer, str.start, str.end,
      ...
      if (pos < 0) {
        ...
        out.value = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.getUTF8CharLength(str.buffer, str.start, pos) + 1;
      }
    }
  ...
  public static class SplitPart implements DrillSimpleFunc {
    ...
    public void eval() {
      if (index.value < 1) {
        throw org.lealone.hansql.common.exceptions.UserException.functionError()
      ...
      for (int i = 1; i < index.value + 1; i++) {
        //Do string match.
        final int pos = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.stringLeftMatchUTF8(str.buffer,
            bufPos, str.end,
        ...
        if (pos < 0) {
          ...
          bufPos = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.getUTF8CharLength(str.buffer, str.start, pos)
              + splitterLen;
  ...
  public static class Strpos implements DrillSimpleFunc {
    ...
    public void eval() {
      //Do string match.
      int pos = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.stringLeftMatchUTF8(str.buffer, str.start, str.end,
                                                                                          substr.buffer, substr.start, substr.end);
      if (pos < 0) {
        out.value = 0; //indicate not found a matched substr.
      } else {
  ...
  public static class LowerCase implements DrillSimpleFunc {
    ...
    @Override
    public void eval() {
      String str = org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(input.start, input.end, input.buffer);
  ...
  public static class Substring implements DrillSimpleFunc {
    ...
    public void eval() {
      ...
      if (length.value <= 0 || offset.value <=0 || string.end <= string.start) {
        ...
        final int charCount = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.getUTF8CharLength(string.buffer, string.start, string.end);
        ...
        if (fromCharIdx > charCount ) { // invalid length, return empty string.
          ...
          out.start = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.getUTF8CharPosition(string.buffer, string.start, string.end, fromCharIdx-1);
          ...
          out.end = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.getUTF8CharPosition(string.buffer, out.start, string.end, charLen);
        }
      }
    }
  }
  ...
  public static class SubstringRegex implements DrillSimpleFunc {
    ...
    public void eval() {
      ...
      if (matcher.find()) {
        ...
        out.start = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.getUTF8CharPosition(input.buffer, input.start, input.end, matcher.start());
        out.end = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.getUTF8CharPosition(input.buffer, input.start, input.end, matcher.end());
      }
    }
  }
  ...
  public static class InitCap implements DrillSimpleFunc {
    ...
    @Override
    public void eval() {
      String source = org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(input.start, input.end, input.buffer);
      String result = org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.initCap(source);
  ...
  public static class Lpad implements DrillSimpleFunc {
    ...
    public void eval() {
      ...
      int textCharCount = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.getUTF8CharLength(text.buffer, text.start, text.end);

      //get the char length of fill.
      int fillCharCount = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.getUTF8CharLength(fill.buffer, fill.start, fill.end);
      ...
      if (theLength <= 0) {
        ...
        out.buffer = text.buffer;
        out.start = text.start;
        out.end = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.getUTF8CharPosition(text.buffer, text.start, text.end, (int) theLength);
      } else if (theLength > textCharCount) {
  ...
  public static class Ltrim implements DrillSimpleFunc {
    ...
    public void eval() {
      ...
      for (int id = text.start; id < text.end; id += bytePerChar) {
        bytePerChar = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.utf8CharLen(text.buffer, id);
        int pos = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.stringLeftMatchUTF8(from.buffer, from.start, from.end,
  ...
  public static class Btrim implements DrillSimpleFunc {
    ...
    public void eval() {
      ...
      for (int id = text.end - 1; id >= text.start; id -= bytePerChar) {
        ...
        bytePerChar = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.utf8CharLen(text.buffer, id);
        final int pos = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.stringLeftMatchUTF8(from.buffer, from.start, from.end,
                                                                                            text.buffer, id, id + bytePerChar);
        if (pos < 0) { // Found the 1st char not in "from", stop
          out.end = id + bytePerChar;
          break;
  ...
  public static class Split implements DrillSimpleFunc {
    ...
    @Output org.lealone.hansql.exec.vector.complex.writer.BaseWriter.ComplexWriter writer;
    ...
    public void setup() {
      ...
      char splitChar = org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.
    ...
    public void eval() {
      String inputString =
          org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(in.start, in.end, in.buffer);
      ...
      org.lealone.hansql.exec.vector.complex.writer.BaseWriter.ListWriter list = writer.rootAsList();
      list.startList();
  ...
  public static class SplitNullableInput implements DrillSimpleFunc {
    ...
    public void eval() {
      ...
      org.lealone.hansql.exec.vector.complex.writer.BaseWriter.ListWriter list = writer.rootAsList();
      list.startList();
      org.lealone.hansql.exec.vector.complex.writer.VarCharWriter varCharWriter = list.varChar();
      for (Object token : tokens) {
        final byte[] strBytes = ((String) token).getBytes(com.google.common.base.Charsets.UTF_8);
        buffer = buffer.reallocIfNeeded(strBytes.length);
        buffer.setBytes(0, strBytes);
  ...
  public static class BinaryString implements DrillSimpleFunc {
    ...
    public void eval() {
      ...
      out.start = out.end = 0;
      out.end = org.lealone.hansql.common.util.DrillStringUtils.parseBinaryString(in.buffer, in.start, in.end, out.buffer);
  ...
  public static class StringBinary implements DrillSimpleFunc {
    ...
    @Override
    public void eval() {
      byte[] buf = org.lealone.hansql.common.util.DrillStringUtils.toBinaryString(in.buffer, in.start, in.end).getBytes(charset);
  ...
  */
  ...
  public static class AsciiEndode implements DrillSimpleFunc {
    ...
    @Override
    public void setup() {
      inCharset = java.nio.charset.Charset.forName(org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers.toStringFromUTF8(enc.start, enc.end, enc.buffer));
    }
  ...
  public static class ReverseString implements DrillSimpleFunc {
    ...
    public void eval() {
      ...
      for (int id = in.start; id < in.end; id += charLen) {
        innerIndex = charLen = org.lealone.hansql.exec.expr.fn.impl.StringFunctionUtil.utf8CharLen(in.buffer, id);
