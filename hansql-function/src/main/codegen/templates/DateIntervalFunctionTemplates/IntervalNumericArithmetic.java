...
<@pp.changeOutputFile name="/org/lealone/hansql/exec/expr/fn/impl/${intervaltype}${numerictype}Functions.java" />
...
<#macro intervalNumericArithmeticBlock left right temp op out intervaltype>
    ...
    fractionalDays += fractionalMonths * org.lealone.hansql.exec.vector.DateUtilities.monthToStandardDays;
    ${out}.days = (int) fractionalDays;

    // Transfer fractional part to millis
    fractionalDays = fractionalDays - (long) fractionalDays;
    fractionalMillis += fractionalDays * org.lealone.hansql.exec.vector.DateUtilities.daysToStandardMillis;
