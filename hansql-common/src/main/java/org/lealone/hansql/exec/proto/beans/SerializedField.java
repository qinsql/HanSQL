...
public final class SerializedField implements Externalizable, Message<SerializedField>, Schema<SerializedField>
{
    ...
    private org.lealone.hansql.common.types.MajorType majorType;
    ...
    public org.lealone.hansql.common.types.MajorType getMajorType()
    {
        return majorType;
    }

    public SerializedField setMajorType(org.lealone.hansql.common.types.MajorType majorType)
    {
        ...
        for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
        {
            switch(number)
            {
                case 0:
                    return;
                case 1:
                    message.majorType = input.mergeObject(message.majorType, org.lealone.hansql.common.types.MajorType.getSchema());
                    break;
    ...
    public void writeTo(Output output, SerializedField message) throws IOException
    {
        if(message.majorType != null)
             output.writeObject(1, message.majorType, org.lealone.hansql.common.types.MajorType.getSchema(), false);
