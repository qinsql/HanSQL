...
public interface GroupScan extends Scan, HasAffinity {
   ...
   * Currently, this is used in {@link org.lealone.hansql.exec.planner.fragment.SimpleParallelizer}
   ...
   * Currently, this is used in {@link org.lealone.hansql.exec.planner.physical.visitor.ExcessiveExchangeIdentifier}
