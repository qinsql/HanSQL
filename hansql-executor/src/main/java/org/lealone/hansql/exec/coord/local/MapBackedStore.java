 ...
 */
package org.lealone.hansql.exec.coord.local;
...
import org.lealone.hansql.exec.coord.store.BaseTransientStore;
...
import org.lealone.hansql.exec.coord.store.TransientStoreEventType;
...
public class MapBackedStore<V> extends BaseTransientStore<V> {
    ...
    public V put(final String key, final V value) {
        ...
        if (old != value) {
            final TransientStoreEventType type = hasKey ? TransientStoreEventType.UPDATE
                    : TransientStoreEventType.CREATE;
