...
import static org.lealone.hansql.exec.ExecConstants.IMPERSONATION_MAX_CHAINED_USER_HOPS;
...
/**
 * Contains context information about view expansion(s) in a query. Part of {@link org.lealone.hansql.exec.ops
 * .QueryContext}. Before expanding a view into its definition, as part of the
 * {@link org.lealone.hansql.exec.planner.logical.DrillViewTable#toRel(ToRelContext, RelOptTable)}, first a
...
public class ViewExpansionContext {
   ...
   * @return An instance of {@link org.lealone.hansql.exec.ops.ViewExpansionContext.ViewExpansionToken} which must be
