...
public interface OpenFileTracker {
  /**
   * Add new file location and {@link org.lealone.hansql.exec.store.dfs.DrillFSDataInputStream} to list.
   */
  public void fileOpened(Path path, DrillFSDataInputStream fsDataInputStream);

  /**
   * Remove the given {@link org.lealone.hansql.exec.store.dfs.DrillFSDataInputStream} from opened file list.
