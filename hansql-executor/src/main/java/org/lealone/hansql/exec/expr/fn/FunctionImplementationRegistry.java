...
import org.lealone.hansql.common.expression.fn.FunctionReplacementUtils;
import org.lealone.hansql.common.scanner.ClassPathScanner;
import org.lealone.hansql.common.scanner.RunTimeScan;
...
import org.lealone.hansql.exec.coord.store.TransientStoreEvent;
import org.lealone.hansql.exec.coord.store.TransientStoreListener;
...
import org.lealone.hansql.exec.expr.fn.registry.FunctionHolder;
import org.lealone.hansql.exec.expr.fn.registry.JarScan;
import org.lealone.hansql.exec.expr.fn.registry.LocalFunctionRegistry;
...
import org.lealone.hansql.exec.resolver.FunctionResolver;
import org.lealone.hansql.exec.resolver.FunctionResolverFactory;
 ...
 * (in {@link LocalFunctionRegistry}), other PluggableFunctionRegistry (e.g., {@link org.lealone.hansql.exec.expr.fn.HiveFunctionRegistry})
...
public class FunctionImplementationRegistry implements FunctionLookupContext, AutoCloseable {
   ...
   * registry.
   *
   * Note: Order of searching is same as order of {@link org.lealone.hansql.exec.expr.fn.PluggableFunctionRegistry}
