...
import org.lealone.hansql.exec.store.parquet.ParquetFormatPlugin;
import org.lealone.hansql.exec.store.parquet.ParquetReaderStats;
import org.lealone.hansql.exec.util.filereader.BufferedDirectBufInputStream;
import org.lealone.hansql.exec.util.filereader.DirectBufInputStream;
...
class PageReader {
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(
      org.lealone.hansql.exec.store.parquet.columnreaders.PageReader.class);

  public static final ParquetMetadataConverter METADATA_CONVERTER = ParquetFormatPlugin.parquetMetadataConverter;

  protected final org.lealone.hansql.exec.store.parquet.columnreaders.ColumnReader<?> parentColumnReader;
  ...
  PageReader(org.lealone.hansql.exec.store.parquet.columnreaders.ColumnReader<?> parentStatus, FileSystem fs, Path path, ColumnChunkMetaData columnChunkMetaData)
  ...
  protected void loadDictionaryIfExists(final org.lealone.hansql.exec.store.parquet.columnreaders.ColumnReader<?> parentStatus,
