...
import org.lealone.hansql.exec.vector.ValueHolderHelper;
      ...
      if (!hasReadPath && !complex) {
        ...
        if (complex || repeated) {
          ...
          if (isNullReaderLikely) {
            ...
            JClass nrClass = generator.getModel().ref(org.lealone.hansql.exec.vector.complex.impl.NullReader.class);
