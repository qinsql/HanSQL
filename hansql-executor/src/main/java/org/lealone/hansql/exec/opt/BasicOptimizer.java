...
import org.lealone.hansql.common.logical.data.SinkOperator;
import org.lealone.hansql.common.logical.data.Store;
import org.lealone.hansql.common.logical.data.Unnest;
import org.lealone.hansql.common.logical.data.Window;
...
import org.lealone.hansql.exec.physical.config.SelectionVectorRemover;
...
//  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(BasicOptimizer.class);
  ...
  private class LogicalConverter extends AbstractLogicalVisitor<PhysicalOperator, Object, OptimizerException> {
    ...
    @Override
    public PhysicalOperator visitLimit(final org.lealone.hansql.common.logical.data.Limit limit,
    ...
    public PhysicalOperator visitProject(final Project project, final Object obj) throws OptimizerException {
      return new org.lealone.hansql.exec.physical.config.Project(
    ...
    public PhysicalOperator visitFilter(final Filter filter, final Object obj) throws OptimizerException {
      ...
      return new SelectionVectorRemover(new org.lealone.hansql.exec.physical.config.Filter(child, filter.getExpr(), 1.0f));
    }
