...
public abstract class AbstractExchange extends AbstractSingle implements Exchange {
   ...
   * @return Sender {@link org.lealone.hansql.exec.planner.fragment.ParallelizationInfo}.
   */
  @Override
   ...
   * @return Receiver {@link org.lealone.hansql.exec.planner.fragment.ParallelizationInfo}.
   */
  @Override
