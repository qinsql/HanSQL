...
import org.lealone.hansql.exec.record.MajorTypeSerDe;
...
public class DrillStatsTable {
    ...
    public static class ColumnStatistics_v1 extends ColumnStatistics {
        ...
        public void buildHistogram(byte[] tdigest_bytearray) {
            ...
            this.histogram = HistogramUtils.buildHistogramFromTDigest(tdigest_bytearray, this.getType(), num_buckets,
                    nonNullCount);
        }
    }
     ...
     * @return map of {@link StatisticsKind} and statistics values
     */
    public static Map<StatisticsKind, Object> getEstimatedColumnStats(DrillStatsTable statsProvider,
