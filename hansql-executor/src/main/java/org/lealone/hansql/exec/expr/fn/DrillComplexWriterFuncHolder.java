...
import org.lealone.hansql.exec.physical.impl.project.ProjectRecordBatch;
import org.lealone.hansql.exec.record.VectorAccessibleComplexWriter;
...
//    jc._then()._return(JExpr.FALSE);
  ...
  protected void checkNullHandling(NullHandling nullHandling) {
    checkArgument(nullHandling == NullHandling.INTERNAL,
        "Function with @Output of type 'org.lealone.hansql.exec.vector.complex.writer.BaseWriter.ComplexWriter'" +
