...
/**
 * Contains information needed by {@link org.lealone.hansql.exec.store.AbstractSchema} implementations.
 */
public class SchemaConfig {
  ...
  /**
   * Interface to implement to provide required info for {@link org.lealone.hansql.exec.store.SchemaConfig}
   */
