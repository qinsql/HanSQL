...
public interface LateralContract {
  ...
  /**
   * Get reference to left side incoming of {@link org.lealone.hansql.exec.physical.impl.join.LateralJoinBatch}.
   * @return The incoming {@link org.lealone.hansql.exec.record.RecordBatch}
   */
