...
import org.lealone.hansql.exec.planner.index.FunctionalIndexHelper;
...
import org.lealone.hansql.exec.planner.index.SimpleRexRemap;
...
public class CoveringIndexPlanGenerator extends AbstractIndexPlanGenerator {
    ...
    public CoveringIndexPlanGenerator(IndexLogicalPlanCallContext indexContext, FunctionalIndexInfo functionInfo,
            IndexGroupScan indexGroupScan, RexNode indexCondition, RexNode remainderCondition, RexBuilder builder,
    ...
    private RexNode rewriteFunctionalCondition(RexNode inputIndex, RelDataType newRowType,
        ...
        return FunctionalIndexHelper.convertConditionForIndexScan(inputIndex, origScan, newRowType, builder,
                functionInfo);
    }
