 ...
 * on debugging, see the explanation in {@link org.lealone.hansql.exec.compile.ClassBuilder}.
 *
 * @param <T>
...
public class CodeGenerator<T> {
  ...
  private static final String PACKAGE_NAME = "org.lealone.hansql.exec.test.generated";
   ...
   * is written to the code directory specified in {@link org.lealone.hansql.exec.compile.ClassBuilder}.
