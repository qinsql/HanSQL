...
public class DrillbitEndpointSerDe {
    ...
    public static class De extends StdDeserializer<DrillbitEndpoint> {
        ...
        @Override
        public DrillbitEndpoint deserialize(JsonParser jp, DeserializationContext ctxt)
    ...
    public static class Se extends StdSerializer<DrillbitEndpoint> {
        ...
        @Override
        public void serialize(DrillbitEndpoint value, JsonGenerator jgen, SerializerProvider provider)
