...
import org.lealone.hansql.exec.expr.fn.impl.StringFunctionHelpers;
...
import org.lealone.hansql.exec.planner.sql.TypeInferenceUtils;
      ...
      Function<ValueHolder, RexNode> literator = valueHolder -> {
        switch (materializedExpr.getMajorType().getMinorType()) {
          ...
          case VARDECIMAL: {
            ...
            return rexBuilder.makeLiteral(
                org.lealone.hansql.exec.util.DecimalUtility.getBigDecimalFromDrillBuf(buffer, start, end - start, scale),
          ...
          case DECIMAL28SPARSE: {
            ...
            return rexBuilder.makeLiteral(
                org.lealone.hansql.exec.util.DecimalUtility.getBigDecimalFromSparse(buffer, start * 20, 5, scale),
          ...
          case DECIMAL38SPARSE: {
            ...
            return rexBuilder.makeLiteral(org.lealone.hansql.exec.util.DecimalUtility.getBigDecimalFromSparse(buffer, start * 24, 6, scale),
                TypeInferenceUtils.createCalciteTypeWithNullability(typeFactory, SqlTypeName.DECIMAL, newCall.getType().isNullable()),
                false);
          }
          case TIME: {
