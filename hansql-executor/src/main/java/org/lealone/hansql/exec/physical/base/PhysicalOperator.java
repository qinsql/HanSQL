...
import org.lealone.hansql.common.graph.GraphValue;
import org.lealone.hansql.exec.ops.QueryContext;
import org.lealone.hansql.exec.planner.cost.PrelCostEstimates;
...
public interface PhysicalOperator extends GraphValue<PhysicalOperator> {
   ...
   * This property is used during physical plan creating using {@link org.lealone.hansql.exec.planner.physical.PhysicalPlanCreator}.
   */
  @JsonIgnore
