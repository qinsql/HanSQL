...
public class SortPrel extends org.lealone.hansql.optimizer.rel.core.Sort implements OrderedRel,Prel {
  ...
  public PhysicalOperator getPhysicalOperator(PhysicalPlanCreator creator) throws IOException {
    ...
    org.lealone.hansql.exec.physical.config.Sort g = new ExternalSort(childPOP, PrelUtil.getOrdering(this.collation, getInput().getRowType()), false);
