...
import org.lealone.hansql.exec.planner.FileSystemPartitionDescriptor;
import org.lealone.hansql.exec.planner.PartitionDescriptor;
import org.lealone.hansql.exec.planner.PartitionLocation;
...
import org.lealone.hansql.exec.store.dfs.MetadataContext.PruneStatus;
...
public abstract class PruneScanRule extends StoragePluginOptimizerRule {
   ...
   * (see {@link org.lealone.hansql.exec.ExecConstants#FILESYSTEM_PARTITION_COLUMN_LABEL}) only
