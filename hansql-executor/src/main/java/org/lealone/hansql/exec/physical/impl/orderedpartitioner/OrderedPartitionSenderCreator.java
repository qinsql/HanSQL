 ...
 * <p>
 *   The {@link org.lealone.hansql.exec.FragmentExecutor} is only aware of the operators in the tree that it has a reference too. In the case of the
 *   {@link OrderedPartitionSenderCreator}, an upstream {@link org.lealone.hansql.exec.record.RecordBatch} is wrapped in an
 *   {@link org.lealone.hansql.exec.physical.impl.orderedpartitioner.OrderedPartitionRecordBatch}. Since the
 *   {@link org.lealone.hansql.exec.physical.impl.orderedpartitioner.OrderedPartitionRecordBatch} is instantiated in the creator the
 *   {@link org.lealone.hansql.exec.FragmentExecutor} does not have a reference to it. So when the {@link org.lealone.hansql.exec.FragmentExecutor}
 ...
 *   {@link OrderedPartitionSenderCreator} allocates {@link org.lealone.hansql.exec.record.VectorContainer}s which are consequentially never released.
 *   <br/>
 *   <ol>
 *     <li>
 ...
 *     </li>
 *     <li>
 *       Or we take a less invasive approach and simply tell the {@link org.lealone.hansql.exec.physical.impl.partitionsender.PartitionSenderRootExec} whether to close the wrapped
 *       operator.
 *     </li>
 *   </ol>
 *   <br/>
