 ...
 * @see org.lealone.hansql.exec.record.AbstractRecordBatch
 * @see org.lealone.hansql.exec.record.AbstractSingleRecordBatch
 * @see org.lealone.hansql.exec.record.AbstractTableFunctionRecordBatch
 * @param <T>
 */
