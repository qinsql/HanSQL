...
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.CATS_COL_CATALOG_CONNECT;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.CATS_COL_CATALOG_DESCRIPTION;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.CATS_COL_CATALOG_NAME;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.COLS_COL_CHARACTER_MAXIMUM_LENGTH;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.COLS_COL_CHARACTER_OCTET_LENGTH;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.COLS_COL_COLUMN_DEFAULT;
...
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.COLS_COL_DATETIME_PRECISION;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.COLS_COL_INTERVAL_PRECISION;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.COLS_COL_INTERVAL_TYPE;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.COLS_COL_IS_NULLABLE;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.COLS_COL_NUMERIC_PRECISION;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.COLS_COL_NUMERIC_PRECISION_RADIX;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.COLS_COL_NUMERIC_SCALE;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.COLS_COL_ORDINAL_POSITION;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_ACCESS_TIME;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_FILE_NAME;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_GROUP;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_IS_DIRECTORY;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_IS_FILE;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_LENGTH;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_MODIFICATION_TIME;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_OWNER;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_PERMISSION;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_RELATIVE_PATH;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_ROOT_SCHEMA_NAME;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_SCHEMA_NAME;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.FILES_COL_WORKSPACE_NAME;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.SCHS_COL_CATALOG_NAME;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.SCHS_COL_IS_MUTABLE;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.SCHS_COL_SCHEMA_NAME;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.SCHS_COL_SCHEMA_OWNER;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.SCHS_COL_TYPE;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.SHRD_COL_TABLE_CATALOG;
...
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.TBLS_COL_TABLE_TYPE;
import static org.lealone.hansql.exec.store.ischema.InfoSchemaConstants.VIEWS_COL_VIEW_DEFINITION;
