...
import org.lealone.hansql.exec.record.VectorAccessibleUtilities;
...
import static org.lealone.hansql.exec.record.RecordBatch.IterOutcome.OUT_OF_MEMORY;
...
public class LateralJoinBatch extends AbstractBinaryRecordBatch<LateralJoinPOP> implements LateralContract {
  ...
  /**
   * Returns the current {@link org.lealone.hansql.exec.record.RecordBatch.IterOutcome} for the left incoming batch
   */
  @Override
  ...
  /**
   * Process left incoming batch with different {@link org.lealone.hansql.exec.record.RecordBatch.IterOutcome}. It is
  ...
  /**
   * Process right incoming batch with different {@link org.lealone.hansql.exec.record.RecordBatch.IterOutcome}. It is
