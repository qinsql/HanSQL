...
public class Fragment implements Iterable<Fragment.ExchangeFragmentPair> {
  ...
  public void addSendExchange(Exchange e, Fragment sendingToFragment) throws SqlExecutorSetupException{
    if (sendingExchange != null) {
      throw new SqlExecutorSetupException("Fragment was trying to add a second SendExchange.  ");
    }
    addOperator(e);
