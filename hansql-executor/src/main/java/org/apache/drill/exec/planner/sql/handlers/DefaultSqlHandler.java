...
public class DefaultSqlHandler extends AbstractSqlHandler {
  ...
  protected ConvertedRelNode validateAndConvert(SqlNode sqlNode) throws SqlExecutorSetupException, RelConversionException, ValidationException {
  ...
  protected Pair<SqlNode, RelDataType> validateNode(SqlNode sqlNode) throws ValidationException, RelConversionException, SqlExecutorSetupException {
