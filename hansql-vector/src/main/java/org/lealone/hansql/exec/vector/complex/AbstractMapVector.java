...
import org.lealone.hansql.common.collections.MapWithOrdinal;
...
public abstract class AbstractMapVector extends AbstractContainerVector {
   ...
   * {@link org.lealone.hansql.exec.vector.ValueVector}.
   *
   ...
   *
   * @return resultant {@link org.lealone.hansql.exec.vector.ValueVector}
   */
  ...
  /**
   * Returns a {@link org.lealone.hansql.exec.vector.ValueVector} corresponding to the given ordinal identifier.
   */
  ...
  /**
   * Returns a {@link org.lealone.hansql.exec.vector.ValueVector} instance of subtype of <T> corresponding to the given
