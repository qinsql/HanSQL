...
public class DecimalUtility {
  ...
  /**
   * Returns default precision for specified {@link org.lealone.hansql.common.types.TypeProtos.MinorType}
   * or returns specified defaultPrecision if {@link org.lealone.hansql.common.types.TypeProtos.MinorType} isn't
   * {@link org.lealone.hansql.common.types.TypeProtos.MinorType#INT} or {@link org.lealone.hansql.common.types.TypeProtos.MinorType#BIGINT}.
   *
   * @param minorType        type wich precision should be received
   * @param defaultPrecision default value for precision
   * @return default precision for specified {@link org.lealone.hansql.common.types.TypeProtos.MinorType}
   */
