...
import org.lealone.hansql.exec.memory.AllocationManager;
 ...
 * {@link org.lealone.hansql.exec.record.DeadBuf dead buffer}. It is important
...
public interface ValueVector extends Closeable, Iterable<ValueVector> {
  ...
  /**
   * Returns a {@link org.lealone.hansql.exec.record.TransferPair transfer pair}, creating a new target vector of
   * the same type.
   */
  ...
  /**
   * Returns a new {@link org.lealone.hansql.exec.record.TransferPair transfer pair} that is used to transfer underlying
   * buffers into the target vector.
   */
  TransferPair makeTransferPair(ValueVector target);

  /**
   * Returns an {@link org.lealone.hansql.exec.vector.ValueVector.Accessor accessor} that is used to read from this vector
   * instance.
   */
  Accessor getAccessor();

  /**
   * Returns an {@link org.lealone.hansql.exec.vector.ValueVector.Mutator mutator} that is used to write to this vector
   * instance.
   */
  Mutator getMutator();

  /**
   * Returns a {@link org.lealone.hansql.exec.vector.complex.reader.FieldReader field reader} that supports reading values
   * from this vector.
   */
