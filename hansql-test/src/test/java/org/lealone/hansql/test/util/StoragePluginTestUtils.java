 ...
 */
package org.lealone.hansql.test.util;
...
public class StoragePluginTestUtils {
     ...
     */
    public static void updateSchemaLocation(final String pluginName, final StoragePluginRegistry pluginRegistry,
            final File tmpDirPath, String... schemas) throws ExecutionSetupException {
        ...
        FileSystemConfig newPluginConfig = new FileSystemConfig(pluginConfig.getConnection(), pluginConfig.getConfig(),
                newWorkspaces, pluginConfig.getFormats());
    ...
    public static void configureFormatPlugins(StoragePluginRegistry pluginRegistry, String storagePlugin)
        ...
        FileSystemConfig newFileSystemConfig = new FileSystemConfig(fileSystemConfig.getConnection(),
                fileSystemConfig.getConfig(), fileSystemConfig.getWorkspaces(), newFormats);
