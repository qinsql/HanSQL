...
public class RelMetadataQuery {
   ...
   *
   * @see #getColumnOrigins(org.lealone.hansql.optimizer.rel.RelNode, int)
   *
   ...
   * {@link BuiltInMetadata.ColumnUniqueness#areColumnsUnique(org.lealone.hansql.optimizer.util.ImmutableBitSet, boolean)}
  ...
  /** As {@link #getAverageColumnSizes(org.lealone.hansql.optimizer.rel.RelNode)} but
