 ...
 * {@link org.lealone.hansql.optimizer.rel.RelCollation} and an Exchange produces output
 * with a particular {@link org.lealone.hansql.optimizer.rel.RelDistribution}, the output
...
public abstract class SortExchange extends Exchange {
  ...
  /**
   * Returns the array of {@link org.lealone.hansql.optimizer.rel.RelFieldCollation}s
   * asked for by the sort specification, from most significant to least
   * significant.
   *
   * <p>See also
   * {@link org.lealone.hansql.optimizer.rel.metadata.RelMetadataQuery#collations(RelNode)},
