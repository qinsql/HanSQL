...
public class ProjectCorrelateTransposeRule extends RelOptRule {
    ...
    public static final ProjectCorrelateTransposeRule INSTANCE = new ProjectCorrelateTransposeRule(expr -> true,
    ...
    public static class RexFieldAccessReplacer extends RexShuttle {
        ...
        public RexNode visitCorrelVariable(RexCorrelVariable variable) {
            if (variable.getCorrelationId().equals(rexCorrelVariableToReplace)) {
