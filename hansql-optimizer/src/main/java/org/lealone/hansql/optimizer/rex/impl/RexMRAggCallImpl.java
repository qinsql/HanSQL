...
public final class RexMRAggCallImpl extends RexCallImpl implements RexMRAggCall {

    private final int ordinal;

    RexMRAggCallImpl(SqlAggFunction aggFun, RelDataType type, List<RexNode> operands, int ordinal) {
