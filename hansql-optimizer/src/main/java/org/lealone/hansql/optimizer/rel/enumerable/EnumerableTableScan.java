...
import org.lealone.hansql.optimizer.schema.QueryableTable;
import org.lealone.hansql.optimizer.schema.ScannableTable;
import org.lealone.hansql.optimizer.schema.Table;

import com.google.common.collect.ImmutableList;

/** Implementation of {@link org.lealone.hansql.optimizer.rel.core.TableScan} in
 * {@link org.lealone.hansql.optimizer.rel.enumerable.EnumerableConvention enumerable calling convention}. */
public class EnumerableTableScan extends TableScan implements EnumerableRel {
    ...
    public boolean equals(Object obj) {
        return obj == this || obj instanceof EnumerableTableScan && table.equals(((EnumerableTableScan) obj).table);
    }
    ...
    public static Class deduceElementType(Table table) {
        ...
        } else if (table instanceof ScannableTable || table instanceof FilterableTable) {
            return Object[].class;
        } else {
            return Object.class;
        }
