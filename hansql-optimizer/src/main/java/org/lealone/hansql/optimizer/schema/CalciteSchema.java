...
public abstract class CalciteSchema {
    ...
    protected CalciteSchema(CalciteSchema parent, Schema schema, String name, NameMap<CalciteSchema> subSchemaMap,
    ...
    public final CalciteSchema getSubSchema(String schemaName, boolean caseSensitive) {
        ...
        for (Map.Entry<String, CalciteSchema> entry : subSchemaMap.range(schemaName, caseSensitive).entrySet()) {
     ...
     * {@link #add(String, org.lealone.hansql.optimizer.schema.Schema)}) and implicit
     * (defined using {@link org.lealone.hansql.optimizer.schema.Schema#getSubSchemaNames()}
     ...
     * {@link org.lealone.hansql.optimizer.schema.CalciteSchema}. */
    private class SchemaPlusImpl implements SchemaPlus {
        ...
        public SchemaPlus getSubSchema(String name) {
            final CalciteSchema subSchema = CalciteSchema.this.getSubSchema(name, true);
