...
public class SqlWindow extends SqlCall {
   ...
   *
   * @see org.lealone.hansql.optimizer.rel.core.Window.Group#isAlwaysNonEmpty()
   * @see SqlOperatorBinding#getGroupCount()
   * @see org.lealone.hansql.optimizer.sql.validate.SqlValidatorImpl#resolveWindow(SqlNode, org.lealone.hansql.optimizer.sql.validate.SqlValidatorScope, boolean)
   */
