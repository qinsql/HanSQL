...
import org.lealone.hansql.optimizer.plan.RelOptNode;
 ...
 * {@link org.lealone.hansql.optimizer.sql.SqlNode} and {@link RexNode}.</p>
 *
 ...
 * a {@link org.lealone.hansql.optimizer.plan.RelImplementor} to manage the process. Every
...
public interface RelNode extends RelOptNode, Cloneable {
   ...
   * @see #accept(org.lealone.hansql.optimizer.rex.RexShuttle)
   */
   ...
   *
   * <p>Note: only {@link org.lealone.hansql.optimizer.rel.core.Correlate} should set
   * variables.
   *
   ...
   * {@link org.lealone.hansql.optimizer.util.Glossary#VISITOR_PATTERN visitor pattern} to
   ...
   * {@link org.lealone.hansql.optimizer.plan.RelOptPlanner#addRule} for each rule, and
