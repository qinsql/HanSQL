...
import org.lealone.hansql.optimizer.util.BarfingInvocationHandler;
...
import org.lealone.hansql.optimizer.util.ConversionUtil;
import org.lealone.hansql.optimizer.util.Glossary;
...
public abstract class SqlUtil {
  ...
  /**
   * Creates the type of an {@link org.lealone.hansql.optimizer.util.NlsString}.
   *
   ...
   * {@link org.lealone.hansql.optimizer.util.BarfingInvocationHandler}, which will throw
   * an error.
   */
  ...
  /** Walks over a {@link org.lealone.hansql.optimizer.sql.SqlNode} tree and returns the
