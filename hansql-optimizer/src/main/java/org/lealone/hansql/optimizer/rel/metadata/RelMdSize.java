 ...
 * {@link org.lealone.hansql.optimizer.rel.metadata.BuiltInMetadata.Size}
...
public class RelMdSize implements MetadataHandler<BuiltInMetadata.Size> {
   ...
   *
   * @see org.lealone.hansql.optimizer.rel.metadata.RelMetadataQuery#getAverageRowSize
   */
   ...
   * invoked using reflection.
   *
   * @see org.lealone.hansql.optimizer.rel.metadata.RelMetadataQuery#getAverageColumnSizes
   */
