 ...
 * {@link org.lealone.hansql.optimizer.rel.metadata.BuiltInMetadata.Memory}
...
public class RelMdMemory implements MetadataHandler<BuiltInMetadata.Memory> {
   ...
   *
   * @see org.lealone.hansql.optimizer.rel.metadata.RelMetadataQuery#memory
   */
   ...
   * invoked using reflection.
   *
   * @see org.lealone.hansql.optimizer.rel.metadata.RelMetadataQuery#cumulativeMemoryWithinPhaseSplit
   */
