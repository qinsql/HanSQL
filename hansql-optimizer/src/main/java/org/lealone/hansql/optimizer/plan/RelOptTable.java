...
public interface RelOptTable extends Wrapper {
   ...
   *
   * <p>The {@link org.lealone.hansql.optimizer.plan.RelOptPlanner planner} calls this
   ...
   * applying {@link org.lealone.hansql.optimizer.plan.RelOptRule rules} to transform it
