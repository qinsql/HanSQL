 ...
 * {@link org.lealone.hansql.optimizer.rel.RelNode relational expression}.</p>
 *
 * <p>Interface {@link org.lealone.hansql.optimizer.plan.RelOptPlanner} defines a planner,
 * and class {@link org.lealone.hansql.optimizer.plan.volcano.VolcanoPlanner} is an
 * implementation which uses a dynamic programming technique. It is based upon
 * the Volcano optimizer [<a href="#graefe93">1</a>].</p>
 *
 * <p>Interface {@link org.lealone.hansql.optimizer.plan.RelOptCost} defines a cost
 * model; class {@link org.lealone.hansql.optimizer.plan.volcano.VolcanoCost} is
 * the implementation for a <code>VolcanoPlanner</code>.</p>
 *
 * <p>A {@link org.lealone.hansql.optimizer.plan.volcano.RelSet} is a set of equivalent
 ...
 * {@link org.lealone.hansql.optimizer.plan.RelTraitDef}.  Manifestations of the trait
 * implement {@link org.lealone.hansql.optimizer.plan.RelTrait}. The most common example
 * of a trait is calling convention: the protocol used to receive and transmit
 * data. {@link org.lealone.hansql.optimizer.plan.ConventionTraitDef} defines the trait
 * and {@link org.lealone.hansql.optimizer.plan.Convention} enumerates the
 ...
 *     </li>
 *     <li>{@link org.lealone.hansql.optimizer.plan.Convention#NONE} means that a
 *         relational
 *         expression cannot be implemented; typically there are rules which can
 *         transform it to equivalent, implementable expressions.
 *     </li>
 *     <li>{@link org.lealone.hansql.optimizer.rel.enumerable.EnumerableConvention}
 ...
 *     implementation of {@link org.lealone.hansql.optimizer.rel.RelNode} should include
 *     its manifestation of the trait as part of the
 *     {@link org.lealone.hansql.optimizer.plan.RelTraitSet} passed to
 *     {@link org.lealone.hansql.optimizer.rel.AbstractRelNode}'s constructor. It may be
 ...
 *     {@link org.lealone.hansql.optimizer.plan.volcano.VolcanoPlanner#setRoot(org.lealone.hansql.optimizer.rel.RelNode)}
 ...
 * {@link org.lealone.hansql.optimizer.rel.AbstractRelNode#clone()} must not assume the
 * type and quantity of traits in their trait set. In either case, the new
 * <code>RelTraitDef</code> implementation must be
 * {@link org.lealone.hansql.optimizer.plan.volcano.VolcanoPlanner#addRelTraitDef(org.lealone.hansql.optimizer.plan.RelTraitDef)}
 * registered with the planner.</p>
 *
 * <p>A {@link org.lealone.hansql.optimizer.plan.volcano.RelSubset} is a subset of a
 ...
 *     defines {@link org.lealone.hansql.optimizer.rel.RelNode relational expressions}.
 * </li>
 * </ul>
 *
 * <h2>Details</h2>
