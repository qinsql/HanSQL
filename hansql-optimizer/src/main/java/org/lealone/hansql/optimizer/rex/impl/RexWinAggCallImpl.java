...
public class RexWinAggCallImpl extends RexCallImpl implements RexWinAggCall {
     ...
     */
    public RexWinAggCallImpl(SqlAggFunction aggFun, RelDataType type, List<RexNode> operands, int ordinal,
            boolean distinct) {
