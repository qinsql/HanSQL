...
public class SqlSetOption extends SqlAlter {
  ...
  /** Name of the option as an {@link org.lealone.hansql.optimizer.sql.SqlIdentifier}
   * with one or more parts.*/
  SqlIdentifier name;

  /** Value of the option. May be a {@link org.lealone.hansql.optimizer.sql.SqlLiteral} or
   * a {@link org.lealone.hansql.optimizer.sql.SqlIdentifier} with one
