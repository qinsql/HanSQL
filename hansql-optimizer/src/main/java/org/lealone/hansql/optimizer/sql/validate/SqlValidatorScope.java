...
import org.lealone.hansql.optimizer.rel.type.StructKind;
...
public interface SqlValidatorScope {
   ...
   * {@link org.lealone.hansql.optimizer.sql.validate.SelectScope}) which can be the
   * context for name-resolution. In scopes such as
   * {@link org.lealone.hansql.optimizer.sql.validate.IdentifierNamespace}, it throws
   ...
   * {@link org.lealone.hansql.optimizer.sql.validate.SqlValidatorScope.Resolved}. */
