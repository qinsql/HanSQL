...
public abstract class ReduceExpressionsRule extends RelOptRule {
  ...
  /**
   * Rule that reduces constants inside a {@link org.lealone.hansql.optimizer.rel.core.Filter}.
   * If the condition is a constant, the filter is removed (if TRUE) or replaced with
   * an empty {@link org.lealone.hansql.optimizer.rel.core.Values} (if FALSE or NULL).
   */
  public static class FilterReduceExpressionsRule extends ReduceExpressionsRule {
     ...
     * to an empty
     * {@link org.lealone.hansql.optimizer.rel.core.Values}.
     *
  ...
  /**
   * Rule that reduces constants inside a {@link org.lealone.hansql.optimizer.rel.core.Project}.
   */
  ...
  /**
   * Rule that reduces constants inside a {@link org.lealone.hansql.optimizer.rel.core.Join}.
   */
  ...
  /**
   * Rule that reduces constants inside a {@link org.lealone.hansql.optimizer.rel.core.Calc}.
   */
