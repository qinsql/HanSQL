 ...
 * to its inputs.
 *
 * <p>Uses {@link org.lealone.hansql.optimizer.rel.metadata.RelMdPredicates} to infer
 * the predicates,
 * returns them in a {@link org.lealone.hansql.optimizer.plan.RelOptPredicateList}
