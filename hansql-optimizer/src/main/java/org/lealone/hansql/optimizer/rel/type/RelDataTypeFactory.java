 ...
 */
package org.lealone.hansql.optimizer.rel.type;
 ...
 * {@link org.lealone.hansql.optimizer.util.Glossary#ABSTRACT_FACTORY_PATTERN abstract factory pattern}.
...
public interface RelDataTypeFactory {
  ...
  /**
   * Creates a
   * {@link org.lealone.hansql.optimizer.rel.type.RelDataTypeFactory.FieldInfoBuilder}.
  ...
  class Builder {
     ...
     * {@link org.lealone.hansql.optimizer.rel.type.RelDataTypeFactory#createSqlType(org.lealone.hansql.optimizer.sql.type.SqlTypeName)}.
     */
    ...
    /**
     * Adds a field with a type created using
     * {@link org.lealone.hansql.optimizer.rel.type.RelDataTypeFactory#createSqlType(org.lealone.hansql.optimizer.sql.type.SqlTypeName, int)}.
     */
    ...
    /**
     * Adds a field with a type created using
     * {@link org.lealone.hansql.optimizer.rel.type.RelDataTypeFactory#createSqlType(org.lealone.hansql.optimizer.sql.type.SqlTypeName, int, int)}.
     */
    public Builder add(String name, SqlTypeName typeName, int precision,
        int scale) {
