...
/**
 * Planner rule that matches an {@link org.lealone.hansql.optimizer.rel.core.Aggregate}
 * on a {@link org.lealone.hansql.optimizer.rel.core.Filter} and transposes them,
 ...
 *
 * @see org.lealone.hansql.optimizer.rel.rules.FilterAggregateTransposeRule
 */
    ...
    public void onMatch(RelOptRuleCall call) {
        ...
        if (allColumnsInAggregate && aggregate.getGroupType() == Group.SIMPLE) {
            ...
            for (AggregateCall aggregateCall : aggregate.getAggCallList()) {
                final SqlAggFunction rollup = getRollup(aggregateCall.getAggregation());
                if (rollup == null) {
                ...
                topAggCallList.add(AggregateCall.create(rollup, aggregateCall.isDistinct(),
                        aggregateCall.isApproximate(), ImmutableList.of(i++), -1, aggregateCall.collation,
