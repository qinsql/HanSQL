...
public class RexDynamicParamImpl extends RexSlotBase implements RexDynamicParam {
     ...
     */
    public RexDynamicParamImpl(RelDataType type, int index) {
    ...
    public boolean equals(Object obj) {
        return this == obj || obj instanceof RexDynamicParamImpl && digest.equals(((RexDynamicParamImpl) obj).digest)
                && type.equals(((RexDynamicParamImpl) obj).type) && index == ((RexDynamicParamImpl) obj).index;
    }
