...
public class RexRangeRefImpl extends RexNodeBase implements RexRangeRef {
    // ~ Instance fields --------------------------------------------------------
     ...
     */
    RexRangeRefImpl(RelDataType rangeType, int offset) {
        super(rangeType);
        this.offset = offset;
    }
    ...
    public boolean equals(Object obj) {
        return this == obj || obj instanceof RexRangeRefImpl && type.equals(((RexRangeRefImpl) obj).type)
                && offset == ((RexRangeRefImpl) obj).offset;
    }
