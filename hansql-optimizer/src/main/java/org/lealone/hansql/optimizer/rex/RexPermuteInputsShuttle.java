 ...
 * @see RexUtil#apply(org.lealone.hansql.optimizer.util.mapping.Mappings.TargetMapping, RexNode)
 */
public class RexPermuteInputsShuttle extends RexShuttle {
     ...
     * {@link org.lealone.hansql.optimizer.util.mapping.Mappings.TargetMapping#getTarget(int)}
    ...
    public RexNode visitInputRef(RexInputRef local) {
        ...
        return RexBuilder.getRexFactory().makeInputRef(target, local.getType());
    }
