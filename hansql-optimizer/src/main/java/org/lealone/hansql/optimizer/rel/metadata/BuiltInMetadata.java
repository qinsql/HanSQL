...
import org.lealone.hansql.optimizer.rex.RexTableInputRef;
...
public abstract class BuiltInMetadata {
  ...
  public interface UniqueKeys extends Metadata {
     ...
     * represented as an {@link org.lealone.hansql.optimizer.util.ImmutableBitSet}, where
  ...
  public interface ExpressionLineage extends Metadata {
     ...
     * in an {@link org.lealone.hansql.optimizer.rel.core.Aggregate} operator)
     */
   ...
   * {@link org.lealone.hansql.optimizer.rel.core.TableScan} for the result predicates.
   */
  ...
  public interface Parallelism extends Metadata {
     ...
     * a leaf node such as a {@link org.lealone.hansql.optimizer.rel.core.TableScan},
     * or with a phase-change node such as an
     * {@link org.lealone.hansql.optimizer.rel.core.Exchange}. Hadoop's shuffle operator
  ...
  public interface Memory extends Metadata {
     ...
     * {@link org.lealone.hansql.optimizer.rel.core.Aggregate} that loads all data into a
